                ...
                <form action="" method="post" id="myform">
                    <div class="user_section">
                        ...
                        <div class="gb_login_layout">
                            ...
                            <input type="text" placeholder="Input your Reg No." name="regno" id="regno" value=""
                                required>
                        </div>
                        ...
                        <div class="gb_login_layout">
                            ...
                            <input type="password" placeholder="Create password" name="password" id="password" value=""
                                required>
                        </div>
                        ...
                        <div class="gb_btn_layout">
                            <input type="checkbox"> <span for=""> I agree to all <a href=""> terms and conditions
                                </a></span><br><br>
                    ...
                    <div class="username_section">
                        ...
                        <div class="gb_login_layout">
                            <i class="bi bi-at"></i>
                            <input type="text" placeholder="Select username" name="username" id="username" value=""
                                required>
                        </div>
                        <div class="gb_btn_layout">
                    ...
                    <div class="profilepic_section">
                        ...
                        <center>
                            <div class="profilePics">
                                <img src="../assets/profilePics/aremoji1.jpg" height="100px" class="selImg1"
                                    width="100px" width="100px" alt="" id="aremoji1.jpg">
                                <img src="../assets/profilePics/aremoji2.jpg" height="100px" class="selImg2"
                                    width="100px" width="100px" alt="" id="aremoji2.jpg">
                                <img src="../assets/profilePics/aremoji3.jpg" height="100px" class="selImg3"
                                    width="100px" width="100px" alt="" id="aremoji3.jpg">
                                <img src="../assets/profilePics/aremoji4.jpg" height="100px" class="selImg4"
                                    width="100px" width="100px" alt="" id="aremoji4.jpg">
                                <img src="../assets/profilePics/aremoji5.jpg" height="100px" class="selImg5"
                                    width="100px" width="100px" alt="" id="aremoji5.jpg">
                                <img src="../assets/profilePics/aremoji6.jpg" height="100px" class="selImg6"
                                    width="100px" width="100px" alt="" id="aremoji6.jpg">
                                <img src="../assets/profilePics/aremoji7.jpg" height="100px" class="selImg7"
                                    width="100px" width="100px" alt="" id="aremoji7.jpg">
                                <img src="../assets/profilePics/aremoji8.jpg" height="100px" class="selImg8"
                                    width="100px" width="100px" alt="" id="aremoji8.jpg">
                                <img src="../assets/profilePics/aremoji9.jpg" height="100px" class="selImg9"
                                    width="100px" width="100px" alt="" id="aremoji9.jpg">
                                <img src="../assets/profilePics/aremoji10.jpg" height="100px" class="selImg10"
                                    width="100px" width="100px" alt="" id="aremoji10.jpg">
                                <img src="../assets/profilePics/aremoji11.jpg" height="100px" class="selImg11"
                                    width="100px" width="100px" alt="" id="aremoji11.jpg">
                                <img src="../assets/profilePics/aremoji12.jpg" height="100px" class="selImg12"
                                    width="100px" width="100px" alt="" id="aremoji12.jpg">
                                <img src="../assets/profilePics/aremoji13.jpg" height="100px" class="selImg13"
                                    width="100px" width="100px" alt="" id="aremoji13.jpg">
                                <img src="../assets/profilePics/aremoji14.jpg" height="100px" class="selImg14"
                                    width="100px" width="100px" alt="" id="aremoji14.jpg">
                                <img src="../assets/profilePics/aremoji15.jpg" height="100px" class="selImg15"
                                    width="100px" width="100px" alt="" id="aremoji15.jpg">
                                <div class="gb_login_layout">
                                    <i class="bi bi-image"></i>
                                    <input type="text" value="" id="myval" class="profilePicVal"
                                        placeholder="profilepic" name="profile_pic">
                                </div>
                            </div>
                            <div class="gb_btn_layout">
