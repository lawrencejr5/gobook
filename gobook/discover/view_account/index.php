                ...
                <div class="ac_container">
                     ...
                     <div class="details">
                        ...
                        <div class="ac_name">
                            ...
                            <?php
                                ...
                                <?php
                                    ...
                                    elseif($check == 0){
                                ?>
                                <button type="submit" style="float: right;" name="add_friend"><i class="bi bi-person-fill-add add_friend"
                                            user_id2="<?=$id?>"
                                            fullname2="<?=$fullname?>"
                                            username2="<?=$username?>"
                                ...
                                ?>
                                 <button type="button" style="background-color: green;float: right; outline: none; color: white; border: 1px solid white;"><i class="bi bi-person-check add_friend"
                                            user_id2="<?=$id?>"
                                            fullname2="<?=$fullname?>"
                                            username2="<?=$username?>"
                        ...
                        <div class="about">
                            ...
                            <a href="./about/?id=<?=$id?>" style="color: rgb(24, 119, 242); font-weight: 600; float: right;">See more...</a>
                        </div>
                    </div>
                </div>
                <?php
                        ...
                        <div class="post">
                            ...
                            <div class="react">
                                <?php
                                    ...
                                    $check_liked = $database -> check_liked($post_id, $uID);
                                ?>
                                <small class="likes"><b><?=$liked?> </b>
                                <?php
                                    if($check_liked == 1){
                                ...
                                <?php
                                        ...
                                        echo '<i class="fa-regular fa-thumbs-up"></i></small>';
                                    }
                                ?>
                                <small class="comments"><b><?=$numOfComments?> </b><i class="fa-regular fa-comment" id="comment" style="cursor: pointer;"></i></small>
                            </div>
                        </div>
                        <hr>
                        <?php
