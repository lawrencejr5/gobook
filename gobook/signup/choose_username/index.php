...
<body>
    ...
    <div class="container-fluid gb_container">
        <div class="gb_login_container">
            <center><h4>Choose A Username</h4></center>
            <br>
            <div class="gb_login_body">
                <form action="" method="post">
                    ...
                    <div class="gb_login_layout">
                        <i class="bi bi-at"></i>
                        <input type="text" placeholder="Select username" name="username" id="username" value="<?=isset($_SESSION['info']['username']) ? $_SESSION['info']['username'] : "" ?>">
                    </div>
                    <div class="gb_btn_layout">
                        <button type="submit" id="selUsername" name="next">Next</button>
                    </div>
                    <br>
                </form>
            </div>
